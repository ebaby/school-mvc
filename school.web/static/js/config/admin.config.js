(function (window) {
    var global = {
        ...
        appPath: '/static/js/app.admin/',
        comLib: '/static/js/comlibs/',
    };
    window.globalConfig = window.globalConfig || global;
})(window)
require.config({
    baseUrl: "/static/js/app.admin/",
    paths: {
        'app': globalConfig.appPath + "app",
        'jquery': globalConfig.libPath + 'jquery.min',
        //'jquery.cookie': globalConfig.libPath + 'jquery.cookie',
        'pagination': window.globalConfig.comLib + 'pagination/jquery.pagination',
        'ping': window.globalConfig.comLib + 'ping/pingpp-pc',
        'angular-local-storage': globalConfig.libPath + 'angular-local-storage',
        ...
        //'angular-moment': globalConfig.libPath + 'angular-moment',
    ...
    shim: {
        ...
        'ping': {
            deps: ['jquery', 'css!' + window.globalConfig.comLib + 'ping/pinus'],
            exports: '$'
        },
        /*'messenger':{
