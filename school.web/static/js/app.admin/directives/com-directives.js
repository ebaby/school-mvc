define(['require','angular'],function(require,ng){
        ...
        return {
            ...
            link: function (scope, elem, attr, ctrl) {
                ...
                xiuxiu.onUploadResponse = function (data) {
                    ...
                    //alert(data);
                    $('#headpic').attr('src', 'http://img1.yqj.cn' + data);

                    scope.imgOptions.setTabindex(0);
        ...
        return{
            ...
            link:function (scope,element,attributes){
                ...
                $(window).bind("scroll", function () {
                    ...
                    //}
                    //if (top > 50) {
                    //    $("#checkcontainer").css("top", "0px");
                    //    //$("#checkcontrol").css("height", (docheight - 170) + "px");
                    //} else {
                    //    $("#checkcontainer").css("top", "100px");
    ...
    }]).directive('subtTime', ['$http', function ($http) {
        return {
            restrict: 'AE',
            scope: {
                timevalue: '='
            ...
            link: function(scope, elem, attrs) {
              ...
              scope.$watchCollection('dateOption.zydatetiem', function (newvalue, oldvalue) {
                  if (newvalue) {
                      ...
                      var datetime = $('<input value="' + zydatetiem + '" class="form-control wdate" style="width:170px;" type="text" readonly="readonly" onfocus="WdatePicker({startDate:\'%y-%M-01 00:00\',dateFmt:\'yyyy-MM-dd HH:mm\',isShowClear:false,isShowToday:false,alwaysUseStartDate:true,qsEnabled:false,onpicked:function(dp){pickerFun(dp)}})" />');
