define(['require', 'angular', 'angularAMD', 'angular-local-storage', 'angular-route', 'ng-dialog', 'angular-toastr', 'angular-loading-bar', 'angular-animate', 'angular-bootstrap', 'uiRouterExtras', 'layout/app-layout.module', 'app.service', 'components/interceptor', 'components/lazyHelper', 'utils/app-utils.module', , 'directives/app-directives.module'], function (require, angular, angularAMD) {
	return angular.module('app', [
		...
		'usermgr/app-usermgr.router',
		'menumgr/app-menumgr.router',
		'articlemgr/app-articlemgr.router',
