define(['require','angular'],function(require,ng){
    ...
    //获取学生列表
	module.controller('AlreadystudentCtrl', ['$scope', '$state', 'checkHomeWorkSrv', 'toastr', function ($scope, $state, checkHomeWorkSrv, toastr) {
	    //$scope.title = '布置作业';
	    $scope.vm = {
	        tabindex: 0,
	        hwindex: 0,
	    ...
	    function _goToDetail(studen) { //app.checkhomework.unalreadyhw.unalreadyhwstudent
	        ...
	        $state.go('app.checkhomework.alreadyhw.result', { tchwlogid: $scope.vm.tchwlogid, sublogid: studen.sublogid, upid: studen.upid, type: 2 });
	    }
